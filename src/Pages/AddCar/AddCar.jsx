...
const AddCar = () => {
  ...
  const handleSubmit = (e)=>{
    ...
    fetch('https://car-rental-server-cyan-ten.vercel.app/cars', {
      method: 'POST',
      headers: {
      ...
      <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select name="category" className="w-full border-2 border-gray-200 rounded-xl p-3   focus:border-blue-500  text-green-800 focus:ring focus:ring-blue-200 transition-all">
